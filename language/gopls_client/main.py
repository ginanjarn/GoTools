...
class GoToolsInitializeCommand(_InitializeCommand):
    """GoToolsInitializeCommand"""


class GoToolsDocumentSignatureHelpCommand(_DocumentSignatureHelpCommand):
    """GoToolsDocumentSignatureHelpCommand"""


class GoToolsDocumentFormattingCommand(_DocumentFormattingCommand):
    """GoToolsDocumentFormattingCommand"""


class GoToolsGotoDefinitionCommand(_GotoDefinitionCommand):
    """GoToolsGotoDefinitionCommand"""


class GoToolsPrepareRenameCommand(_PrepareRenameCommand):
    """GoToolsPrepareRenameCommand"""
...
class GoToolsApplyTextChangesCommand(_ApplyTextChangesCommand):
    """GoToolsApplyTextChangesCommand"""


class GoToolsStartServerCommand(_StartServerCommand):
    """GoToolsStartServerCommand"""


class GoToolsTerminateServerCommand(_TerminateServerCommand):
    """GoToolsTerminateServerCommand"""
